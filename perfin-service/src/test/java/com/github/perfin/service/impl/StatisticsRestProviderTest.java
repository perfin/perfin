...
@Transactional
public class StatisticsRestProviderTest {

    @InjectMocks
    StatisticsRestProvider statisticsRestProvider = new StatisticsRestProvider();

    @Spy
    @InjectMocks
    private StatisticsProviderImpl statisticsProvider = new StatisticsProviderImpl();
    ...
    public void testGetStatisticsByDateRange() throws Exception {
        Statistics statistics = statisticsRestProvider.getStatisticsByDateRange(null, null);
